...
There are 508 observations for 14 variables. There are no missing values in this data set. The first 22 lines are removed, because those lines only contain explanatory notes but no actual data.\
